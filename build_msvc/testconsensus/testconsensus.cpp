...
// vivuscoin includes.
#include <..\src\script\vivuscoinconsensus.h>
...
int main()
{
    std::cout << "vivuscoinconsensus version: " << vivuscoinconsensus_version() << std::endl;
    ...
    auto op0Result = vivuscoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, vivuscoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
