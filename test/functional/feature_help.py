...
"""Verify that starting vivuscoin with -h works as expected."""

from test_framework.test_framework import VivuscoinTestFramework
from test_framework.util import assert_equal

class HelpTest(VivuscoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vivuscoin with -h for help text")
        ...
        self.log.info("Start vivuscoin with -version for version information")
        ...
        self.log.info("Start vivuscoind with -fakearg to make sure it does not start")
