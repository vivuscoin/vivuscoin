...
This document provides guidelines for internationalization of the Vivuscoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vivuscoin_en.ts` remains unchanged.
