Vivuscoin Core version 0.13.2 is now available from:

  <https://vivuscoin.org/bin/vivuscoin-core-0.13.2/>
...
- #8908 `4a974b2` Update vivuscoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow vivuscoin-tx to create v2 transactions (vvcdrak)
