Vivuscoin Core version *0.14.3* is now available from:

  <https://vivuscoin.org/bin/vivuscoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/vivuscoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
