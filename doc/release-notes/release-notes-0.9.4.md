Vivuscoin Core version 0.9.4 is now available from:

  https://vivuscoin.org/bin/0.9.4/
...
this update is incompatible with the Vivuscoin system and could lead to consensus
forks.

Vivuscoin Core released binaries from https://vivuscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~vivuscoin/+archive/ubuntu/vivuscoin
- A third-party or self-compiled Vivuscoin Core

upgrade to Vivuscoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
