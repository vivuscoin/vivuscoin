Vivuscoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/vivuscoin/files/Vivuscoin/vivuscoin-0.5.4/
...
http://gitorious.org/vivuscoin/vivuscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Vivuscoin-Qt notifications under Growl 1.3.
Increase required age of Vivuscoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxVivuscoin properly when installing Vivuscoin-Qt over it. (Windows)
