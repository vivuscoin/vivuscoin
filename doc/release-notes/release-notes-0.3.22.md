Download URL: https://sourceforge.net/projects/vivuscoin/files/Vivuscoin/vivuscoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 VVC fee schedule (users still pay 0.01 VVC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #vivuscoin00 - #vivuscoin99
