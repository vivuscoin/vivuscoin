Vivuscoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/vivuscoin/files/Vivuscoin/vivuscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Vivuscoin
...
New/changed settings (command-line or vivuscoin.conf file)
--------------------------------------------------------
