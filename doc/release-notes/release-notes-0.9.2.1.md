Vivuscoin Core version 0.9.2.1 is now available from:

  https://vivuscoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 VVC to 0.01 VVC
...
- Fix "Start vivuscoin on system login"
