Vivuscoin Core version 0.16.1 is now available from:

  <https://vivuscoin.com/bin/vivuscoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting vivuscoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure vivuscoind processes are cleaned up when tests end (sdaftuar)
