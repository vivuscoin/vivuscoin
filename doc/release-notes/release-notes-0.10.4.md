Vivuscoin Core version 0.10.4 is now available from:

  <https://vivuscoin.org/bin/vivuscoin-core-0.10.4/>
...
- #6953 `43c2789` Split vivuscoin-tx into its own package
- #6953 `dfe0d4d` Include vivuscoin-tx binary on Debian/Ubuntu
