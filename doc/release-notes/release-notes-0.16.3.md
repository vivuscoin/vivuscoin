Vivuscoin Core version 0.16.3 is now available from:

  <https://vivuscoin.com/bin/vivuscoin-core-0.16.3/>
...
been discovered in Vivuscoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` vivuscoinconsensus: invalid flags error should be set to `vivuscoinconsensus_err` (afk11)
