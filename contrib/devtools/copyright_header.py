...
Arguments:
    <base_directory> - The base directory of a vivuscoin source code repository.
...
Arguments:
    <file> - A source file in the vivuscoin repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Vivuscoin
