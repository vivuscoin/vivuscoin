...
#ifndef VIVUSCOIN_KEYSTORE_H
#define VIVUSCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/vivuscoin/bips/blob/master/bip-0013.mediawiki
