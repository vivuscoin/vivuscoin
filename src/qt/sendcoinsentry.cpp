    ...
    platformStyle(_platformStyle)
{
    ...
    // normal vivuscoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying vivuscoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &VivuscoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
