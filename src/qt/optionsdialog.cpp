    ...
    mapper(nullptr)
{
    ...
    ui->vivuscoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->vivuscoinAtStartup);
    ...
    ui->vivuscoinAtStartup->setToolTip(ui->vivuscoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->vivuscoinAtStartup->setText(ui->vivuscoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openVivuscoinConfButton->setToolTip(ui->openVivuscoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new VivuscoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->vivuscoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openVivuscoinConfButton_clicked()
{
