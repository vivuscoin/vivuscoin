...
#ifndef VIVUSCOIN_QT_SPLASHSCREEN_H
#define VIVUSCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Vivuscoin Core initialization
...
#endif // VIVUSCOIN_QT_SPLASHSCREEN_H
