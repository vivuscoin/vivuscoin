...
#ifndef VIVUSCOIN_QT_VIVUSCOINUNITS_H
#define VIVUSCOIN_QT_VIVUSCOINUNITS_H
...
/** Vivuscoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VivuscoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VivuscoinUnits(QObject *parent);

    /** Vivuscoin units.
      @note Source: https://en.vivuscoin.com/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        VVC,
    ...
    //! Number of Parvuses (1e-8) per unit
    ...
    //! Return maximum number of base units (Parvuses)
    static CAmount maxMoney();

private:
    QList<VivuscoinUnits::Unit> unitlist;
};
typedef VivuscoinUnits::Unit VivuscoinUnit;

#endif // VIVUSCOIN_QT_VIVUSCOINUNITS_H
