...
//! Entry point for VivuscoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &VivuscoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for VivuscoinGUI tests.
void AppTests::guiTests(VivuscoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &VivuscoinGUI::consoleShown, this, &AppTests::consoleTests);
