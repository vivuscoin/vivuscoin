...
#ifndef VIVUSCOIN_INTERFACES_NODE_H
#define VIVUSCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a vivuscoin node (vivuscoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // VIVUSCOIN_INTERFACES_NODE_H
