...
static void SetupVivuscoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " vivuscoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  vivuscoin-tx [options] <hex-tx> [commands]  Update hex-encoded vivuscoin transaction\n" +
            "or:     vivuscoin-tx [options] -create [commands]   Create hex-encoded vivuscoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vivuscoin transaction
