...
#ifndef VIVUSCOIN_TXMEMPOOL_H
#define VIVUSCOIN_TXMEMPOOL_H
...
public:
     ...
     * https://github.com/vivuscoin/vivuscoin/pull/14193 will fix it. No known code
     * in vivuscoin currently depends on second guarantee, but it is important to
