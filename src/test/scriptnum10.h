...
#ifndef VIVUSCOIN_TEST_SCRIPTNUM10_H
#define VIVUSCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Vivuscoin Core 0.10.0, for cross-comparison.
 */
public:
