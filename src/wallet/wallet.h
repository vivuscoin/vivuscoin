...
#ifndef VIVUSCOIN_WALLET_WALLET_H
#define VIVUSCOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! vivuscoin from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this vivuscoin node, and set to 0 for transactions that were created
...
#endif // VIVUSCOIN_WALLET_WALLET_H
