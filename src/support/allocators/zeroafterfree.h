...
#ifndef VIVUSCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define VIVUSCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // VIVUSCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
