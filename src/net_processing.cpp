...
#if defined(NDEBUG)
# error "Vivuscoin cannot be compiled without assertions."
#endif
...
static constexpr int64_t STALE_CHECK_INTERVAL = 24 * 60 * 60 * 365;
...
/// protection against fingerprinting. Set to one year, denominated in seconds.
static constexpr int STALE_RELAY_AGE_LIMIT = 365 * 24 * 60 * 60;
    ...
    while (!done && !orphan_work_set.empty()) {
        ...
        if (AcceptToMemoryPool(mempool, stateDummy, porphanTx, &fMissingInputs2, &removed_txn, false /* bypass_limits */, 0 /* nAbsurdFee */)) {
            ...
            if (!orphanTx.HasWitness() && !stateDummy.CorruptionPossible()) {
                ...
                // See https://github.com/vivuscoin/vivuscoin/issues/8279 for details.
                assert(recentRejects);
